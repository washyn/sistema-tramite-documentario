...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Administracion de tr&aacute;mites recibidos</h1>
      </div>
      <div class="col-sm-6">
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            ...
            <button class="btn btn-info btn-sm float-right" id="btn_registrar" onclick="cargar_contenido('contenido_principal','documento/vista_documento_registro.php')"><i class="fas fa-plus"></i>&nbsp;Nuevo registro</button>
          </div>
...
<div class="modal fade bs-example-modal-lg" id="modal_registrar_derivar">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <form autocomplete="false" id="form_derivar_finalizar_tramite">
        <div class="modal-body">
            <div class="box-body" >
              <div class=" col-12">
                <div class="row">
